...
def login_lagi334():
	try:
		...
		print('%s# COOKIES KADALUWARSA / AKUN ANDA KENA CP '%(h))
		exit()
...
def dump_publik():
	...
	try:
		...
		teks = '# ID TIDAK BERSIFAT PUBLIK MASUKIN YG BENER'
...
def dump_massal():
	...
	if pilih in ['1','01']:
		...
		print(x+'['+h+'•'+x+'] MASUKAN TOTAL ID LIMIT [20]')
		try:
			jum = int(input(x+'['+p+'f'+x+'] MASUKAN JUMLAH : '))
		except ValueError:
